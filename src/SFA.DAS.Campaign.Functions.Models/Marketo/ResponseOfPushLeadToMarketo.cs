...
namespace SFA.DAS.Campaign.Functions.Models.Marketo
{
    ...
    public partial class ResponseOfPushLeadToMarketo :  IEquatable<ResponseOfPushLeadToMarketo>, IValidatableObject
    {
        ...
        public ResponseOfPushLeadToMarketo(List<Error> errors = default(List<Error>), string requestId = default(string), List<Lead> result = default(List<Lead>), bool success = default(bool), List<Warning> warnings = default(List<Warning>))
        {
            ...
            if (errors == null)
            {
                throw new InvalidDataException("errors is a required property for ResponseOfPushLeadToMarketo and cannot be null");
            }
            else
            {
                this.Errors = errors;
            ...
            if (requestId == null)
            {
                throw new InvalidDataException("requestId is a required property for ResponseOfPushLeadToMarketo and cannot be null");
            }
            else
            {
            ...
            if (result == null)
            {
                throw new InvalidDataException("result is a required property for ResponseOfPushLeadToMarketo and cannot be null");
            }
            else
            {
                this.Result = result;
            ...
            if (success == null)
            {
                throw new InvalidDataException("success is a required property for ResponseOfPushLeadToMarketo and cannot be null");
            }
            else
            {
            ...
            if (warnings == null)
            {
                throw new InvalidDataException("warnings is a required property for ResponseOfPushLeadToMarketo and cannot be null");
            }
            else
            {
