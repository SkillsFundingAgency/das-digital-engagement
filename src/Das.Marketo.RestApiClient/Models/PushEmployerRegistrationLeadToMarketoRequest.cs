...
namespace Das.Marketo.RestApiClient.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class PushEmployerRegistrationLeadToMarketoRequest : IEquatable<PushEmployerRegistrationLeadToMarketoRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public PushEmployerRegistrationLeadToMarketoRequest(List<EmployerRegistrationLead> input = default(List<EmployerRegistrationLead>), string lookupField = default(string), string partitionName = default(string), string programName = default(string), string programStatus = default(string), string reason = default(string), string source = default(string))
        {
            this.Input = input;
        ...
        public List<EmployerRegistrationLead> Input { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PushEmployerRegistrationLeadToMarketoRequest {\n");
        ...
        /// <returns>Boolean</returns>
        public bool Equals(PushEmployerRegistrationLeadToMarketoRequest input)
        {
            if (input == null)
                return false;
